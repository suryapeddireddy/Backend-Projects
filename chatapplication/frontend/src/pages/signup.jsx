...
const Signup = () => {
  ...
  return (
   ...
   <FaRegUser className="text-white text-xl"></FaRegUser>
   <input type="text" className="border border-gray-300 bg-transparent text-white w-full" placeholder="Username" onChange={(e) => setUsername(e.target.value)}></input>
   </div>
   <div className="flex bg-gray-700  items-center gap-2 rounded p-2">
